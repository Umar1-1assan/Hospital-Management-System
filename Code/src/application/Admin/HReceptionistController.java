...
public class HReceptionistController implements CotrollerIF 
{
	private AdminManager adminManager;
	private User user;
	private ObservableList<Receptionist> obsList = FXCollections.observableArrayList();
    ...
    @FXML
    private TableView<Receptionist> List;
    ...
    @FXML
    private TableColumn<Receptionist,String> name_t;
    ...
    @FXML
    private TableColumn<Receptionist,String> username_t;
    ...
    {
    	Receptionist d = this.List.getSelectionModel().getSelectedItem();
    	if(d==null)
    	{
    	...
    	if(this.adminManager.removeReceprionist((d.getUsername())))
    	{
    ...
    {
    	Receptionist selectedDoctor = List.getSelectionModel().getSelectedItem();
        ...
        try {
        	Receptionist doctor = this.adminManager.getReceptionist(username);
            if (doctor != null) 
            {
    ...
    void add_update(MouseEvent event) throws ClassNotFoundException, SQLException 
    {
    	try {
	        ...
	        boolean success = adminManager.addUpdateReceprionist (
	            name_f.getText().trim(),
	            addr_f.getText().trim(),
	            cnic_f.getText().trim(),
    ...
    void search(MouseEvent event) throws ClassNotFoundException, SQLException {
    	...
    	ArrayList<Receptionist> doctors = this.adminManager.getReceptionists(searchname);
        obsList.clear(); 
	...
	public void loadDeatails() throws ClassNotFoundException, SQLException {
		...
		ArrayList<Receptionist> doctors = this.adminManager.getReceptionists();
        obsList.clear(); 
        obsList.addAll(doctors); 
        List.setItems(obsList); 
