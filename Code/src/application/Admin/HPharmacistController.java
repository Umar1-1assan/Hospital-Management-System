...
public class HPharmacistController implements CotrollerIF 
{
	private AdminManager adminManager;
	private User user;
	private ObservableList<Pharmacist> obsList = FXCollections.observableArrayList();
    ...
    @FXML
    private TableView<Pharmacist> List;
    ...
    @FXML
    private TableColumn<Pharmacist,String> name_t;
    ...
    @FXML
    private TableColumn<Pharmacist,String> username_t;
    ...
    {
    	Pharmacist d = this.List.getSelectionModel().getSelectedItem();
    	if(d==null)
    	{
    	...
    	if(this.adminManager.removePharmacist((d.getUsername())))
    	{
    ...
    {
    	Pharmacist selectedDoctor = List.getSelectionModel().getSelectedItem();
        ...
        try {
        	Pharmacist doctor = this.adminManager.getPharmacist(username);
            if (doctor != null) 
            {
    ...
    void add_update(MouseEvent event) throws ClassNotFoundException, SQLException 
    {
    	try {
	        ...
	        boolean success = adminManager.addUpdatePharmacist (
	            name_f.getText().trim(),
	            addr_f.getText().trim(),
	            cnic_f.getText().trim(),
    ...
    void search(MouseEvent event) throws ClassNotFoundException, SQLException {
    	...
    	ArrayList<Pharmacist> doctors = this.adminManager.getPharmacists(searchname);
        obsList.clear(); 
	...
	public void loadDeatails() throws ClassNotFoundException, SQLException {
		...
		ArrayList<Pharmacist> doctors = this.adminManager.getPharmacists();
        obsList.clear(); 
        obsList.addAll(doctors); 
        List.setItems(obsList); 
